...
var speed = 2;
var wKeyPressed = false, sKeyPressed = false;
var paddleDirection;
...
beforeInit();
  ...
  */
function beforeInit(){
    context = $('#pongKeyboard')[0].getContext("2d");
    renderNet();
    renderLeft();
    renderRight();
    drawScores();
...
function setSpeed(){
 ...
 /*
  * This function is called when the player lifts the key pressed and flips the values of the movement booleans.
  */
function onKeyUp(event){
 ...
 /*
  * This function is called when the player presses the key pressed and flips the values of the movement booleans.
  */
...
function drawScores(){
 ...
 /*
  * This function is called when a player scores 7 points. It also cancels the update loop.
  */
function finishGame(winner){
 ...
 /*
  * This function is the main game loop. It is called every screen update and detects for key presses, redraws elements
  * and controls the AI movement.
  */
function update(){
    clearCanvas();
    detectWin();
  ...
  * starts the screen update process
  */
function init(){
    buttonCounter++;
